...
AWS.config.credentials = new AWS.Credentials('AKIAICPC7HJVLRONPWZA', 'wIXEkWXalI8hoznGCdBjTjcV4AQL+/fu4d1KwMP3');
var dynamodb = new AWS.DynamoDB();
var datumVal = new Date() - 240000;
var addr = location.search.split('addr=')[1];
if (addr === undefined)
  addr = 'Sim';
var params = { 
                ...
                ExpressionAttributeValues: {
                  ":iottopic": { "S" : "temp-humidity/DiaperSens-" + addr},
